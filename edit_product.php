...
if (isset($_POST['update'])) {
	...
	move_uploaded_file($temp_name4,"product_images/$product_img5");
	move_uploaded_file($temp_name5,"product_images/$product_img5");

	$update_product="update products set p_cat_id='$product_cat',cat_id='$cat',date=NOW(),product_title='$product_title',product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_img4='$product_img4',product_img5='$product_img5',product_price='$product_price',product_keyword='$product_keyword' where product_id='$p_id'";
